...
switch ($_GET["op"]){
	case 'guardaryeditar':
		...
		if (empty($idusuario)){
			$rspta=$usuario->insertar($username,$contraseniahash,$email,$imagen,$_POST['permiso']);
			echo $rspta ? "Usuario registrado" : "No se pudieron registrar todos los datos del usuario";
		}
		else {
			$rspta=$usuario->editar($idusuario,$username,$contraseniahash,$email,$imagen,$_POST['permiso']);
