<?php
    ...
    class Pacienteasociado{
        ...
        public function insertar($cedula, $nombres, $apellidos, $email, $telefono, $direccion, $ciudad_residencia, $fecha_nacimiento, $genero, $cliente, $imagen, $iduser)
        {
        ...
        public function editar($idpersona, $cedula, $nombres, $apellidos, $email, $telefono, $direccion, $ciudad_residencia, $fecha_nacimiento, $genero, $imagen, $cliente)
        {
            $sql= "UPDATE persona SET cedula ='$cedula', nombres ='$nombres', apellidos ='$apellidos', email ='$email', telefono ='$telefono',
            direccion ='$direccion', ciudad_residencia ='$ciudad_residencia', fecha_nacimiento ='$fecha_nacimiento', genero ='$genero', imagen ='$imagen', idasociado ='$cliente'
