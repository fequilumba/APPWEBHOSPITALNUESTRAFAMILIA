                    ...
                    <div class="panel-body" style="height: 600px;" id="formularioregistros">
                        <form name="formulario" id="formulario" method="POST">
                          <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <input type="number" name="cedula" id="cedula" class="form-control" maxlength="10" minlength="10" onkeypress="return soloNumeros(event)"  placeholder="Cédula" required>
                            </div>
                            <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                              ...
                              <input type="number" name="telefono" id="telefono" class="form-control" onkeypress="return soloNumeros(event)" placeholder="Teléfono">
                            </div>
