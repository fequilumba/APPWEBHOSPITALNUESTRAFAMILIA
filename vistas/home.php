...
<div class="content-wrapper">
  <section class="content">
    ...
    <div>
      <p class="text-success">El Hospital "Nuestra Familia"  cuenta con acreditación internacional tipo oro otorgada por la prestigiosa organización 
    ...
    <h2 class="text-center text-primary">ESPECIALIDADES</h2>
